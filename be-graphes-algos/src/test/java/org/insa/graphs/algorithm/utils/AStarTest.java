...
public class AStarTest {
    ...
    public void testCheminQuiNeFonctionnePas() {
        ...
        astar = new AStarAlgorithm(Pietons);
        attendu = null;
        calcule = astar.run().getPath();
        assertTrue(("[" + nomDuTest + "] Attendu : " + attendu + "; Calculé : " +calcule), attendu == calcule);
